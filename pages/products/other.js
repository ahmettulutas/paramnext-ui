...
export async function getStaticProps () {
  return {
    props: {
      pageInfo: await getContentfulPage("productsAdditionalServicesPage")
    }
  };
}

const
  productName = productNames.other,
  ...
  Other = ({ pageInfo }) => {
    ...
    const
      ...
      { heroTitle, heroSubtitle, heroDescription, pageMetaDescription, services, productTitle, productDescription, servicesImage, quickHelpFormTitle } = pageInfo.items[0].fields;
