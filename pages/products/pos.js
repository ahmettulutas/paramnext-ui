...
export async function getStaticProps () {
  return {
    props: {
      pageInfo: await getContentfulPage("productsPosPage")
    }
  };
}
const
  productName = productNames.pos,
  ...
  Pos = ({ pageInfo }) => {
    const
      ...
      { heroTitle, heroSubtitle, heroDescription, pageMetaDescription, /* services, */ solutions, productTitle, productDescription, solutionsImage } = pageInfo.items[0].fields;
        ...
        <PageContent className="mt-144 mb-144">
          <Row gutter={[50, 100]} className="container-responsive-centered tablet">
            ...
            <Col xs={24} sm={22} lg={14}>
              <Products solutions={omitLocale(solutions)} />
            </Col>
          </Row>
        </PageContent>
